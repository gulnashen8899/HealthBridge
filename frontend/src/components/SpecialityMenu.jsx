...
const SpecialityMenu = () => {
  return (
    <div className='flex flex-col items-center gap-4 py-16 text-gray-800' id='speciality'>
          ...
          <p className='sm:w-1/3 text-center text-sm'>Browse through our extensive list of trusted and top doctors for you, schedule your appointment hassle-free according to you</p>
