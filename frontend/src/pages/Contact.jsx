  ...
  return (
    ...
    <div className='my-10 flex flex-col justify-center md:flex-row gap-10 mb-28 text-sm'>
      ...
      <div className='flex flex-col justify-center items-start gap-6'>
        ...
        <p className='text-gray-600 '>Bidhanagar , Salt Lake- Sector V, <br/> Kolkata, West Bengal, India</p>
        <p className='text-gray-600' >Tel: (412) 667-0945<br/>Email:healthbridge@gmail.com</p>
