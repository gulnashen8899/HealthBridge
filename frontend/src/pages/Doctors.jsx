...
const Doctors = () => {
  ...
  const [filteredDoc, setFilterDoc]=React.useState([]);
  ...
  return (
    <div>
        ...
        <div className='flex flex-col sm:flex-row items-start gap-5 mt-5'>
          <button className={`py-1 px-3 border rounded text-sm transition-all sm:hidden ${showFilter?'bg-[#07BC] text-white':''}`} onClick={()=>setShowFilter(prev=>!prev)}>Filters</button>
          ...
          <div className='w-full grid grid-cols-[repeat(auto-fit,minmax(200px,300px))] gap-4 gap-y-6'>
            {
